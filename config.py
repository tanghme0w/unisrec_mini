class Config:
    def __init__(
        ...
        self.config = dict()
        self.config['data_path'] = "user_item_interaction_data.jsonl"
        self.config['worker'] = 0
        self.config['single_spec'] = True
        self.config['mmap_idx_path'] = 'idx.mmap_100'
        self.config['mmap_idx_shape'] = (100,)
        self.config['mmap_emb_shape'] = (100, 768)
        self.config['mmap_emb_path'] = 'data.mmap_100_768'
        ...
        self.config['pretrain_epochs'] = 100
